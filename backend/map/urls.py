...
urlpatterns = format_suffix_patterns([
    ...
    path('landmarks_overview/', views.LandmarkOverviewList.as_view(), name='landmark_overview_list'),
    path('landmarks/<int:pk_lm>/', views.LandmarkDetail.as_view(), name='landmark_detail'),
    path('landmarks_overview/<int:pk_lm>/', views.LandmarkOverviewDetail.as_view(), name='landmark_overview_detail'),
    ...
    path('landmarks/<int:pk_lm>/contents_overview/', views.LandmarkContentOverviewList.as_view(), name='landmark_content_overview_list'),
    ...
    path('contents_overview/', views.ContentOverviewList.as_view(), name='content_overview_list'),
    path('contents/<int:pk_ct>/', views.ContentDetail.as_view(), name='content_detail'),
    path('contents_overview/<int:pk_ct>/', views.ContentOverviewDetail.as_view(), name='content_overview_detail'),
    ...
    path('search_fast/', views.SearchFast.as_view(), name='search_fast'),
